...
void loop() 
{
  ...
  if (packetSize ) // filter Snr && LoRa.packetSnr() <= 9.00
  {
    ...
    if (winner_value <= 101 + slide_value)
      distance = 0;
    else if (winner_value >= 102+slide_value && winner_value <= 104+slide_value)
        distance = 1;
    else if (winner_value >= 105+slide_value && winner_value <= 107+slide_value)
        distance = 2;
    else if (winner_value >= 108+slide_value  && winner_value <= 109+slide_value)
        distance = 3;
    else if (winner_value >= 110+slide_value && winner_value <= 111+slide_value)
        distance = 4;
    else if (winner_value >= 112+slide_value)
        distance = 5;
